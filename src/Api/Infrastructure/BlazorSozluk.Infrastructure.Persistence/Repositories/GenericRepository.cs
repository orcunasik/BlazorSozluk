...
namespace BlazorSozluk.Infrastructure.Persistence.Repositories
{
    public class GenericRepository<TEntity> : IGenericRepository<TEntity> where TEntity : BaseEntity
    {
        ...
        {
            dbContext.RemoveRange(this.entity.Where(predicate));
        ...
        {
            if (!this.entity.Local.Any(i => EqualityComparer<Guid>.Default.Equals(i.Id, entity.Id))) dbContext.Update(entity);
            return dbContext.SaveChanges();
        }
        ...
        public virtual Task BulkDeleteById(IEnumerable<Guid> ids)
        {
            ...
            dbContext.RemoveRange(this.entity.Where(i => ids.Contains(i.Id)));
            return dbContext.SaveChangesAsync();
        }
        ...
        {
            if (noTracking)
                return await this.entity.AsNoTracking().ToListAsync();
        ...
        {
            TEntity found = await this.entity.FindAsync(id);
